---
title: 'Index.js 는 어떻게 포스트의 데이터를 읽을까'
date: '2022-01-12'
...
이번에는 이 파일에 무엇이 있고 저 대괄호는 무슨 뜻을 가지는지 한 번 살펴봅시다.
...
빌드 시간에 생성되지 않은 페이지에 대한 page 에 대한 설정 값을 반환합니다.

자세히 살펴보면 getStaticPath 함수는 paths 와 fallback 을 리턴합니다.
