...
| SC-016   | MUST_PASS  | in_this_slice          | Check, lint, build, E2E, Lighthouse, `npm run audit:axe`, `npm run audit:links`, `npm run audit:web`, static local link check, keyboard spot check, RSS/dark-mode/search accessibility regressions, screenshots. | None for local automated acceptance.                   |
