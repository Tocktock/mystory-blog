    ...
    details: [
      {
        title: '역할',
        items: [
          { label: '역할', value: '제품팀 Backend SW Engineer / Lead' },
          { label: '담당', value: '운송관리·차주 매칭·운영 도구 백엔드' },
          { label: '범위', value: '도메인 기준 정리, 배포·관측성 개선' },
        ],
      },
    ],
    highlights: [
...
export const companyWorkAreas = [
  ...
  },
  {
    ...
    proofs: [
      {
        label: '지도 검색 API',
        value: '배포 후 운영 관찰 구간 기준 1초 이상 요청 0건',
      },
      {
        label: '같은 구간 내 최대 응답',
        value: '약 239ms',
  ...
  },
  {
    number: '03',
    label: '플랫폼 운영',
    title: '배포와 관측성 흐름을 ECS 중심으로 전환했습니다.',
    proofs: [
      {
        label: '배포 전환',
  ...
  },
  {
    number: '04',
    label: '운송 도메인',
    title: '운송 요청부터 배차까지의 실행 흐름을 Dispatch 기준으로 정리했습니다.',
    proofs: [
      {
        label: '다룬 범위',
