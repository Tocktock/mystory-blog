...
pubDate: 2021-01-11T10:29:10.155Z
description: '문제풀러가기✈유명한 DP 문제 2 x N 타일링의 업그레이드 버전 이젠 세로의 길이가 2가 아니라 3이다!!DP 공식을 잘 유도하면 쉽게 풀 수 있다!!자세한 문제 설명과 제한 사항은 프로그래머스 홈페이지 참고. 문제풀러가기dp 공식을 유도해야하는데 순서대로 잘 그려보'
category: 'tech'
series: 'algorithms'
tags:
  - algorithm
