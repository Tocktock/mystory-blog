---
title: '이력 | 지용의 기록실'
description: '화물 물류 도메인에서 JiYong이 다뤄온 백엔드, 플랫폼 운영, 데이터 전환, AI 업무 자동화 작업을 정리한 이력 페이지입니다.'
source: '/career'
...
- 보완 방식: 기존 입력 데이터 · 운영 사용 흐름 기반 후보 제안
...
- 지도 검색 API: 배포 후 일정 기간 운영 관찰 기준 1초 이상 요청 0건
- 같은 구간 내 최대 응답 시간: 약 239ms
...
- 범위: 도메인 상태 기준 수립, API 조회 흐름 정비, 배포·관측성 개선
